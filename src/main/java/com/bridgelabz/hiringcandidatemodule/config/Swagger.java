package com.bridgelabz.hiringcandidatemodule.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.hiringcandidatemodule.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("hiringcandidatemodule",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("hiringcandidatemodule", "http://bridgelabz.hiringcandidatemodule", "swasthikkj@gmail.com"),
                "Apache 2.0",
